...
public Classe (String nome, String bab, Dado dv, String tempra, String riflessi, String volontà) {
    int t, r, v;
    this.Nome = nome;
    this.ModAttacco = bab;
    this.DadoVita = dv;
...
public int getModAttacco(int livello) {
    int BAB;
        if (ModAttacco == "V") {BAB= livello;} // bonus di attaco
...
public String getVolontà() {
return Volontà;
}
public int getVolontà(int livello) {
    int volontà;
    if (Volontà != "A") {volontà= livello/3;} // volontà
        else {volontà= 2+(livello/2);}
    return volontà;
}
public void setVolontà(String v) {
this.Volontà = v;
}
...
public String StampaClasse () {
    int livello, tempra, riflessi, volontà, BAB;
    ...
    for (livello = 1; livello < 21; livello++) {
        ...
        s = s+"BAB "+BAB+" - T-> "+tempra+" R-> "+riflessi+" V-> "+volontà+"\n";
        }
    return s;
}
